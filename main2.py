...
from main_models import Publisher, Book, Shop, Stock, Sale, create_tables
...
book1 = Book(title='Пробуждение', publisher=pub1)
book2 = Book(title='Зов кукушки', publisher=pub2)
session.add_all([book1, book2])
session.commit()

sh1 = Shop(name='Буквоед')
sh2 = Shop(name='Дом книги')
sh3 = Shop(name='Читай город')
